                ...
                <div className="space-y-2">
                  {sessions.map((session) => (
                    <div
                      ...
                      className={`p-4 border rounded-lg cursor-pointer transition-all ${selectedSession?._id === session._id
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-gray-500 mt-1">
                            {session.createdAt ? format(new Date(session.createdAt), 'MMM dd, yyyy HH:mm') : 'N/A'}
                          </p>
                        </div>
                ...
                <div className="space-y-4">
                  <div className="border-b pb-3">
                    ...
                    <div className="text-sm text-gray-600 space-y-2">
                      ...
                      <div>
                        <strong>Started:</strong> {selectedSession.createdAt ? format(new Date(selectedSession.createdAt), 'MMM dd, yyyy HH:mm') : 'N/A'}
                      </div>
                    </div>
                  </div>
                        ...
                        {messages.map((message, idx) => (
                          ...
                          >
                            <div className="flex items-center justify-between mb-2">
                              <span className={`text-xs font-semibold ${message.sender === 'user'
                                  ? 'text-primary-700'
                                  : message.sender === 'technician'
                                    ? 'text-blue-700'
                                    : 'text-gray-700'
                              ...
                              <span className="text-xs text-gray-500">
                                {message.createdAt ? format(new Date(message.createdAt), 'MMM dd, HH:mm') : format(new Date(), 'MMM dd, HH:mm')}
                              </span>
                            </div>
