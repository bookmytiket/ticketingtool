              ...
              <div className="grid grid-cols-3 gap-2">
                {DEMO_CREDENTIALS.map((cred) => (
                  <button
                    ...
                    className="flex flex-col items-center gap-1 py-3 px-2 rounded-xl border transition-all duration-200 hover:scale-105 active:scale-95"
                    style={{
                      backgroundColor: activeDemo === cred.label
                        ? `${cred.color}20`
                        : isDarkMode ? 'rgba(255,255,255,0.04)' : 'rgba(0,0,0,0.03)',
                      borderColor: activeDemo === cred.label
                        ? `${cred.color}60`
                        : isDarkMode ? 'rgba(255,255,255,0.12)' : 'rgba(0,0,0,0.1)',
                      boxShadow: activeDemo === cred.label
                        ? `0 0 12px ${cred.color}30`
                        : 'none',
                    }}
                  >
                    ...
                    <span
                      ...
                      style={{ color: activeDemo === cred.label ? cred.color : textColor }}
                    >
                      {cred.label}
                    </span>
                    <span
